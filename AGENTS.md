...
| Directory | Purpose |
|-----------|---------|
| `shared/` | TextMate 문법 파일 단일 소스 |
| `language-server/` | QTN Language Server — LSP 구현 |
| `vscode-extension/` | VSCode 확장 — LSP 클라이언트 + 문법 + 테스트 |
| `jetbrains-plugin/` | JetBrains Rider 플러그인 — TextMate + LSP |
| `tests/` | 공유 테스트 픽스처 |
