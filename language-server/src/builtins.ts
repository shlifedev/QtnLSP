...
export const QUANTUM_TYPES: BuiltinTypeInfo[] = [
  ...
  { name: 'IntVector2', category: 'quantum', csharpType: 'Quantum.IntVector2', descriptions: { en: 'Integer 2D vector', ko: '정수 2D 벡터' } },
  { name: 'IntVector3', category: 'quantum', csharpType: 'Quantum.IntVector3', descriptions: { en: 'Integer 3D vector', ko: '정수 3D 벡터' } },
  { name: 'Transform2D', category: 'quantum', csharpType: 'Quantum.Transform2D', descriptions: { en: 'Built-in 2D transform component (position + rotation)', ko: '내장 2D 트랜스폼 컴포넌트 (위치 + 회전)' } },
  { name: 'Transform3D', category: 'quantum', csharpType: 'Quantum.Transform3D', descriptions: { en: 'Built-in 3D transform component (position + rotation)', ko: '내장 3D 트랜스폼 컴포넌트 (위치 + 회전)' } },
  { name: 'CharacterController2D', category: 'quantum', csharpType: 'Quantum.CharacterController2D', descriptions: { en: 'Built-in 2D kinematic character controller component', ko: '내장 2D 키네마틱 캐릭터 컨트롤러 컴포넌트' } },
  { name: 'CharacterController3D', category: 'quantum', csharpType: 'Quantum.CharacterController3D', descriptions: { en: 'Built-in 3D kinematic character controller component', ko: '내장 3D 키네마틱 캐릭터 컨트롤러 컴포넌트' } },
  { name: 'PhysicsBody2D', category: 'quantum', csharpType: 'Quantum.PhysicsBody2D', descriptions: { en: 'Built-in 2D physics body component', ko: '내장 2D 물리 바디 컴포넌트' } },
  { name: 'PhysicsBody3D', category: 'quantum', csharpType: 'Quantum.PhysicsBody3D', descriptions: { en: 'Built-in 3D physics body component', ko: '내장 3D 물리 바디 컴포넌트' } },
  { name: 'PhysicsCollider2D', category: 'quantum', csharpType: 'Quantum.PhysicsCollider2D', descriptions: { en: 'Built-in 2D physics collider component', ko: '내장 2D 물리 콜라이더 컴포넌트' } },
  { name: 'PhysicsCollider3D', category: 'quantum', csharpType: 'Quantum.PhysicsCollider3D', descriptions: { en: 'Built-in 3D physics collider component', ko: '내장 3D 물리 콜라이더 컴포넌트' } },
  { name: 'PhysicsCallbacks2D', category: 'quantum', csharpType: 'Quantum.PhysicsCallbacks2D', descriptions: { en: 'Built-in 2D physics callbacks component', ko: '내장 2D 물리 콜백 컴포넌트' } },
  { name: 'PhysicsCallbacks3D', category: 'quantum', csharpType: 'Quantum.PhysicsCallbacks3D', descriptions: { en: 'Built-in 3D physics callbacks component', ko: '내장 3D 물리 콜백 컴포넌트' } },
  { name: 'PhysicsJoints2D', category: 'quantum', csharpType: 'Quantum.PhysicsJoints2D', descriptions: { en: 'Built-in 2D physics joints component', ko: '내장 2D 물리 조인트 컴포넌트' } },
  { name: 'PhysicsJoints3D', category: 'quantum', csharpType: 'Quantum.PhysicsJoints3D', descriptions: { en: 'Built-in 3D physics joints component', ko: '내장 3D 물리 조인트 컴포넌트' } },
  { name: 'ColorRGBA', category: 'quantum', csharpType: 'Quantum.ColorRGBA', descriptions: { en: 'RGBA color (byte components)', ko: 'RGBA 색상 (바이트 성분)' } },
  { name: 'NullableNonNegativeFP', category: 'quantum', csharpType: 'Quantum.NullableNonNegativeFP', descriptions: { en: 'Nullable non-negative fixed-point number', ko: 'Null 허용 음수 불가 고정소수점 수' } },
  { name: 'RNGSession', category: 'quantum', csharpType: 'Quantum.RNGSession', descriptions: { en: 'Deterministic random number generator session', ko: '결정론적 난수 생성기 세션' } },
  { name: 'FrameTimer', category: 'quantum', csharpType: 'Quantum.FrameTimer', descriptions: { en: 'Frame-based timer', ko: '프레임 기반 타이머' } },
  { name: 'NavMeshPathfinder', category: 'quantum', csharpType: 'Quantum.NavMeshPathfinder', descriptions: { en: 'Built-in navmesh pathfinder component', ko: '내장 내비메시 패스파인더 컴포넌트' } },
  { name: 'NavMeshSteeringAgent', category: 'quantum', csharpType: 'Quantum.NavMeshSteeringAgent', descriptions: { en: 'Built-in navmesh steering agent component', ko: '내장 내비메시 조향 에이전트 컴포넌트' } },
  { name: 'NavMeshAvoidanceAgent', category: 'quantum', csharpType: 'Quantum.NavMeshAvoidanceAgent', descriptions: { en: 'Built-in navmesh avoidance agent component', ko: '내장 내비메시 회피 에이전트 컴포넌트' } },
  { name: 'MapEntityId', category: 'quantum', csharpType: 'Quantum.MapEntityId', descriptions: { en: 'Map entity identifier', ko: '맵 엔티티 식별자' } },
  { name: 'AssetGuid', category: 'quantum', csharpType: 'Quantum.AssetGuid', descriptions: { en: 'Asset GUID value', ko: '에셋 GUID 값' } },
  { name: 'QBoolean', category: 'quantum', csharpType: 'Quantum.QBoolean', descriptions: { en: 'Quantum deterministic boolean', ko: 'Quantum 결정론적 부울' } },
  { name: 'Ptr', category: 'quantum', csharpType: 'Quantum.Ptr', descriptions: { en: 'Frame heap pointer', ko: '프레임 힙 포인터' } },
  { name: 'InputButtons', category: 'quantum', csharpType: 'Quantum.InputButtons', descriptions: { en: 'Input buttons bitmask', ko: '입력 버튼 비트마스크' } },
  { name: 'InputDirection', category: 'quantum', csharpType: 'Quantum.InputDirection', descriptions: { en: 'Compressed input direction', ko: '압축된 입력 방향' } },
];
